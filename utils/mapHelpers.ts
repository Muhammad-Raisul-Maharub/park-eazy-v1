...
export const getVehicleMarkerIcon = (status: ParkingSlotStatus, type: ParkingSlotType, state: { isHovered?: boolean, isClicked?: boolean, isNew?: boolean } = {}) => {
    ...
    const svg = `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 42" width="32" height="42" style="filter: drop-shadow(0 3px 3px rgba(0,0,0,0.3));">
            <defs>
            ...
            <path fill="url(#grad-${status})" stroke="white" stroke-width="1.5" d="M16 0C7.164 0 0 7.164 0 16c0 9.5 16 26 16 26s16-16.5 16-26c0-8.836-7.164-16-16-16z"/>
